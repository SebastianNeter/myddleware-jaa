...
class moodle_custom extends moodle
{
    ...
    public function getFieldsLogin(): array
    {
        return [
   		 ...
   		 'type' => TextType::class,
   		 'label' => 'Group custom fields (shortname separated by coma)',
            ],
        ];
    }
	...
	// Function to add custom fields for course, user and group modules.
